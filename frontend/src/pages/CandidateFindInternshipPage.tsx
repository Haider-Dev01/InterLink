...
import { candidateNavItems, internshipSuggestions } from '../lib/data/dashboardData';
        ...
        <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="space-y-6">
            <SurfaceCard className="p-8" data-animate="card">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="mt-3 text-2xl font-black text-on-surface">{draft.keywords}</h3>
                </div>
                <div className="rounded-2xl bg-primary/10 px-4 py-2 text-right">
                  ...
                  <p className="mt-1 text-lg font-black text-primary">{draft.format}</p>
                </div>
              </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-1">
              {internshipSuggestions.map((offer) => (
                <SurfaceCard className="p-6" data-animate="card" key={`${offer.company}-${offer.title}`}>
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-2 text-sm text-on-surface-variant">
                        {offer.location} · {offer.type} · {offer.salary}
                      </p>
                    </div>
                    <div className="rounded-2xl bg-gradient-to-br from-primary to-secondary px-4 py-3 text-white shadow-lg shadow-primary/20">
                      ...
                      <p className="mt-1 text-2xl font-black">{offer.score}%</p>
                    </div>
                  </div>
                </SurfaceCard>
              ))}
